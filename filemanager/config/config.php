...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/VTD_home/'.system::theme('index').'/public/filemanager/source/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../VTD_home/'.system::theme('index').'/public/filemanager/source/',
	...
	|
	*/
	'thumbs_base_path' => '../VTD_home/'.system::theme('index').'/public/filemanager/thumbs/',
	...
	*/
	...
	|--------------------------------------------------------------------------*/
	'ftp_thumbs_dir' => '../VTD_home/'.system::theme('index').'/public/filemanager/thumbs/',
	'ftp_ssl' => false,
	'ftp_port' => 21,
